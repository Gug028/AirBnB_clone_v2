...
# create City state_id="d36d0fc-509c-4b29-81d0-1ae0b4b7025f" city_name="San_Francisco_is_super_cool"
if result is None or result == "":
    print("FAIL: No ID retrieved")
...
if "user_id" not in result or user_id not in result:
    print("FAIL: missing new informatio: \"{}\"".format(result))
...
if "price_by_night" not in result or str(place_pric) not in result:
    print("FAIL: missing new information: \"{}\"".format(result))
